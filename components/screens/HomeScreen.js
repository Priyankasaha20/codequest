                        ...
                        <div className="space-y-8 text-left">
                            ...
                            <div className="flex items-center space-x-8 pt-4">
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-claret-500 montserrat-bold">95%</div>
                                    <div className="text-sm text-onyx-600 montserrat-regular">Success Rate</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-claret-500 montserrat-bold">500+</div>
                                    <div className="text-sm text-onyx-600 montserrat-regular">Companies</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-claret-500 montserrat-bold">24/7</div>
                                    <div className="text-sm text-onyx-600 montserrat-regular">AI Support</div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="mt-8 flex justify-center items-center space-x-8 text-white/80 text-sm">
                        <div className="flex items-center">
                            ...
                            <span className="montserrat-regular">No Credit Card Required</span>
                        </div>
                        <div className="flex items-center">
                            <CheckCircle className="w-4 h-4 mr-2" />

    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 px-6 py-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#features"
              className="text-onyx-600 hover:text-claret-500 transition-colors"
            >
              Features
            </a>
            <a
            ...
            <button
              ...
              className="bg-claret-500 text-white hover:bg-claret-600 font-medium px-6 py-2 rounded-lg transition-all duration-200 hover:shadow-lg"
            >
              Sign In
            </button>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 text-left">
              <div className="space-y-4">
                <div className="inline-flex items-center px-3 py-1 bg-tea-green-100 text-tea-green-700 rounded-full text-sm font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={() => setCurrentScreen("login")}
                  className="bg-claret-500 text-white hover:bg-claret-600 px-8 py-4 rounded-lg font-semibold transition-all duration-200 hover:shadow-lg flex items-center justify-center"
                >
                  Get Started Free
                ...
                <button
                  ...
                  className="border-2 border-onyx-200 text-onyx-700 hover:bg-onyx-50 px-8 py-4 rounded-lg font-semibold transition-all duration-200 hover:border-onyx-300"
                >
                  Watch Demo
                </button>
              </div>
              ...
              <div className="flex items-center space-x-8 pt-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-claret-500">95%</div>
                  <div className="text-sm text-onyx-600">Success Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-claret-500">500+</div>
                  <div className="text-sm text-onyx-600">Companies</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-claret-500">24/7</div>
                  <div className="text-sm text-onyx-600">AI Support</div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-alabaster-200">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2 py-1 bg-claret-100 text-claret-700 text-xs rounded-full">
                      Hard
                    </span>
                  </div>
                  <h3 className="font-semibold text-onyx-700">
                    Binary Tree Maximum Path Sum
                  </h3>
                  <div className="flex items-center space-x-4 text-sm text-onyx-600">
                    <span>⏱️ 30 mins</span>
                    <span>🏆 100 points</span>
                  </div>
                  <div className="bg-alabaster-50 p-4 rounded-lg">
                    <code className="text-sm text-onyx-700">
                      def maxPathSum(root):
                      <br />
                      &nbsp;&nbsp;# Your solution here...
                    </code>
                  </div>
                  <button className="w-full bg-claret-500 text-white py-3 rounded-lg font-medium hover:bg-claret-600 transition-colors">
                    Start Solving
                  </button>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="group p-8 rounded-2xl border border-alabaster-200 hover:border-claret-200 hover:shadow-lg transition-all duration-200">
              ...
              <h3 className="text-xl font-semibold text-onyx-700 mb-3">
                AI Interview Coach
              </h3>
      ...
      <section className="py-20 bg-claret-500">
        <div className="container mx-auto px-6 text-center">
          ...
          <button
            onClick={() => setCurrentScreen("login")}
            className="bg-white text-claret-600 px-10 py-4 rounded-lg font-semibold text-lg hover:bg-alabaster-50 transition-all duration-200 hover:shadow-lg inline-flex items-center"
          >
